(function () {
  ...
  const routes = {
    ...
    "/general-ledger-reconciliations": { en: "/general-ledger-reconciliations", es: "/es/libro-mayor-conciliaciones", pt: "/pt/razao-geral-conciliacoes" },
    "/es/libro-mayor-conciliaciones": { en: "/general-ledger-reconciliations", es: "/es/libro-mayor-conciliaciones", pt: "/pt/razao-geral-conciliacoes" },
    "/pt/razao-geral-conciliacoes": { en: "/general-ledger-reconciliations", es: "/es/libro-mayor-conciliaciones", pt: "/pt/razao-geral-conciliacoes" },
  ...
  style.textContent = `
    ...
    .site-header .usaba-language { margin-left:8px; }
    .usaba-language-button { width:70px; display:flex; align-items:center; justify-content:center; gap:3px; min-height:44px; padding:0 5px; border:1px solid #12b9df; border-radius:7px; background:#fff; color:#082c67; font-size:12px; font-weight:800; cursor:pointer; }
    ...
    .image-hotspots .usaba-language { position:absolute; left:auto; right:calc(10.75% - 17px); top:3.2%; z-index:30; }
    .image-hotspots .usaba-language-button { box-sizing:border-box; width:56px; min-width:56px; max-width:56px; min-height:0; height:44px; max-height:44px; gap:2px; padding:0 2px; border-radius:7px; background:rgba(255,255,255,.96); }
