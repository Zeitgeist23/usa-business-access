...
script_tag = '  <script src="banking-menu.js" defer></script>'
anchor = '  <script src="services-menu.js" defer></script>'
if script_tag not in html:
    if anchor not in html:
        raise SystemExit('services-menu.js script tag not found')
...
'''
Path('banking-menu.js').write_text(banking_js, encoding='utf-8')
